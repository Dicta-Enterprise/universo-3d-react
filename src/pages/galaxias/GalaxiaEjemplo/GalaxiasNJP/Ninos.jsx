...
export default function Ninos(gals) {
    ...
    <>
      ...
      {showCard && selectedGalaxy && (
        <TarjetaConfirmacion
          ...
          descripcion={selectedGalaxy.descripcion}
          onClose={handleClose}
        />
      )}
      ...
      <section style={{color:"white",position:"relative", zIndex:999, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"end", width:"100%", height:(window.innerWidth < 650?"90":"80")+"vh", boxSizing:"border-box", textAlign:"center"}}>
            ...
            <p className='quicksand text-responsive' style={{margin:(window.innerWidth < 420?"0rem 1rem 10rem 1rem":"5rem"), fontSize:"1.5rem",position:"relative", zIndex:999,color:"white", textAlign:"center", textShadow:"0 0 20px black"}}>¡Protege tu mundo digital! Conoce los riesgos y los secretos para estar seguro.</p>
        </section>
