...
const Planeta6Ele = () => {
  ...
  const planetaNombre = "ELEKTRON";
  const resumenCurso = (
    <div>
      <p>Descubre los secretos del planeta ELEKTRON, un mundo de contrastes vibrantes donde:</p>
      <ul>
