    ...
    // Rutas de las imágenes
        ...
        return (
            <div style={{
                ...
                <ThreeSceneBackground textures={textures} planetUrls={planetUrls} showCarousel={showCarousel} initialPlanetIndex={7} />
