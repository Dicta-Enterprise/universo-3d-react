...
const PlanetaCOMMUNIS = () => {
    ...
    const planetUrls = [
        ...
        '/padres/salud_social/planeta_communi', // Principal al Seleccionar
    ...
    // Rutas de las imágenes
        ...
        return (
            <div style={{
                ...
                <ThreeSceneBackground textures={textures} planetUrls={planetUrls} showCarousel={showCarousel} initialPlanetIndex={1}  />
...
export default PlanetaCOMMUNIS;