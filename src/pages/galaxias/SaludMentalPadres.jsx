...
export default function EsferaTexturizada() {
    ...
    const planetUrls = [
        '/padres/salud_mental/planeta_kio',
        '/padres/salud_mental/planeta_2',
        '/padres/salud_mental/planeta_3',
        '/padres/salud_mental/planeta_4',
        '/padres/salud_mental/planeta_5',
        '/padres/salud_mental/planeta_6',
        '/padres/salud_mental/planeta_7',
